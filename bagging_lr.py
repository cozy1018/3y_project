...
print("Processing data with two classes to build Logistic Regression models, applying feature scaling, one-hot encoding, and hyperparameter tuning.")
...
# Initialize Logistic Regression and Bagging Models
logreg_model = LogisticRegression(random_state=42, max_iter=1000)

# Define BaggingClassifier with Logistic Regression
...
print("Processing data with two classes to build Logistic Regression models, applying feature scaling, SMOTE, one-hot encoding, and hyperparameter tuning.")

# Case 2: With SMOTE
print("\n### Case 2: Training and Testing With SMOTE ###")

# Reload and process the dataset again for SMOTE
df = pd.read_csv("datafile/heart_disease_uci.csv")
df = df[df['dataset'] == "Cleveland"]  
df = df[df['age'] != 28]  
