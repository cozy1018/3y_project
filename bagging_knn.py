...
# Initialize KNN and Bagging Models
knn_model = KNeighborsClassifier()

# Define BaggingClassifier with KNN
...
print("Processing data with two classes to build KNN models, applying feature scaling, SMOTE, one-hot encoding, and hyperparameter tuning.")
