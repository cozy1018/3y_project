...
# Function to train and evaluate the KNN model with grid search and permutation importance
...
# Without SMOTE
num_features_no_smote, accuracies_no_smote, features_used_no_smote, test_accuracies_no_smote, all_features_no_smote = train_and_evaluate_knn_with_gridsearch(
    X, y
)
...
plt.title('Test Accuracy vs Number of Features (KNN with GridSearchCV, no SMOTE)')
plt.grid()
plt.show()
