...
print("Processing data with two classes to build Naïve Bayes models, applying feature scaling, one-hot encoding, and hyperparameter tuning.")
...
# Initialize Naïve Bayes and Bagging Models
nb_model = GaussianNB()

# Define BaggingClassifier with Naïve Bayes
...
###############################
###############################
print("Processing data with two classes to build Naïve Bayes models, applying feature scaling, SMOTE, one-hot encoding, and hyperparameter tuning.")
# Case 2: With SMOTE
